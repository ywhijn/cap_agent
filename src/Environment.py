    ...
    def GetItinerary(self, origin, destination, method = 'straight'):
        ...
        if method == 'API':
            ...
            if self.consider_congestion:
                itinerary = ox.routing.shortest_path(self.road_network, origin, destination, weight='time', cpus=16)
            else:
                itinerary = ox.routing.shortest_path(self.road_network, origin, destination, weight='length', cpus=16)
